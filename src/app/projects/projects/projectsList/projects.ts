  ...
  export const projects = [
    {
      id: 4,
      title: 'MUZZI',
      description: 'The application is a Party Game that focuses on finding more about our friends or family by getting everyone together through music. Throughout this project, I was responsible for the planning, development and testing of the application. As a result, I was capable to quickly learn FLUTTER and the entire process of how to publish an application on the APP STORE&PLAY STORE.',
      technologies: 'Technologies: Flutter, Dart, Firebase, REST.',
      thumbnailImagePath: './assets/images/muzzi_app_1.png',
      about: "The mobile application was a side project that I developed alongside three friends, during my last year of university. MUZZI allows friends and family to join together in the same lobby and find more about each other through music. For the music provider, we used the DEEZER API's.", 
    ...
    },
    {
      id: 3,
      title: 'ECON',
      description: 'ECON is a multi-platform touchscreen desktop application that manages all the mechanical systems for a retail shop. This application was made on request from a big international retailer. I worked as a team with another software developer and our project manager using Agile methodology. Its features include: creating posts, real-time messaging and a responsive search system.',
      ...
      about: "The JavaFx application was developed for a big multinational retailer. With the goal of rewriting an existing application so it can be executed on different platforms (Linux, Windows, macOS). The Application itself allowed in-store staff to have live data access for most of the mechanical systems that are in a store (HVAC, Boilers, etc).  It allowed as well to make some small changes to the schedule and some of the mechanical systems.", 
